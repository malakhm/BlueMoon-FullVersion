...
<body>
        <table border="border" style="margin: 0 auto">
            <caption style="font-size: x-large; font-weight: 800;">View All News</caption>
            <tr>
                <th>News ID</th>
                <th>Title</th>
                <th>Content</th>
            ...
            for ($i = 0; $i < $nbr; $i++) {
                ...
                echo "<td><a href='blogAdmin.php?news_id=$row[news_id]'><button class='btn btn-info'>Edit</button></a></td>";
                echo "</tr>";
            }
            echo "</table>";
        }
