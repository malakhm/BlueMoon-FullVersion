...
if ($_SESSION['isloggedin'] != 1) {
    ...
    $query = "Select * from restaurant_reservation where status='pending'";
...
<table border="border" style="display:flex; margin-left:300px">
    ...
    <caption>View All Pending Restaurant & Bar Reservations</caption>
    <tr>
    ...
    for ($i=0; $i<$nbr ; $i++) {
        ...
        echo "<td><a href='confirmtable.php?reservation_id=$row[reservation_id]'><button class='btn btn-success'>confirm</button></a></td>";
        echo "<td><a href='canceltable.php?reservation_id=$row[reservation_id]'><button class='btn btn-danger'>cancel</button></a></td>";
        echo "</tr>";
    }
echo "</table>";
